  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Algo saiu do esperado. Você pode tentar recarregar ou voltar para a home.
        </p>
  ...
  head: () => ({
    meta: [
      ...
      { title: SITE_NAME },
      {
        name: "description",
        content:
          "Escritório de advocacia com atuação estratégica em Direito do Trabalho, do Consumidor e Civil e Família.",
      },
